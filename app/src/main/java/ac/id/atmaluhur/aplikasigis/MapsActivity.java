package ac.id.atmaluhur.aplikasigis;
...
import ac.id.atmaluhur.aplikasigis.api.ApiClient;
import ac.id.atmaluhur.aplikasigis.api.ApiService;
import ac.id.atmaluhur.aplikasigis.model.ListLocationModel;
import ac.id.atmaluhur.aplikasigis.model.LocationModel;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void initMarker(List<LocationModel> ListData){
        //iterasi semua data dan tampilkan markenya
        for (int i=0; i<mListMarker.size(); i++){
            ...
            //lalu arahkan zooming ke marker index 0
